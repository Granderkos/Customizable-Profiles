<?php
            ...
            $creation = mysqli_fetch_row($conn->query("SELECT * FROM userdata WHERE username = 'nn'"))[3];
                        ...
                        if (isset($user)) {
                            if ($user == $username) {
                                ...
                                if (file_exists("../images/banner/$username-banner.png")) {
                                    echo '<script>document.querySelector(`.banner`).style.backgroundImage = `url(' . '../images/banner/nn-banner.png' . ')`;</script>';
                                }
                    ...
                    <nav>
                        <ul>
                            ...
                            if (file_exists("../images/pfp/$username-pfp.png")) {
                                echo '<script>document.querySelector(`.pfp`).style.backgroundImage = `url(' . '../images/pfp/nn-pfp.png' . ')`;</script>';
                            }
                        ...
                        <section id="user-stats">
                                ...
                                <?php
                                    if(isset($_COOKIE["selected"]))
                                    {
                                        if(strlen($_COOKIE["selected"]) > 0)
                                        {
                                            ...
                                            echo mysqli_fetch_row($conn->query("SELECT games FROM ".$name."_data WHERE username = 'nn'"))[0]; 
                                        }
                                    }
                                    ?>
                                </p>
                            ...
                            <div class="uStat-last">
                                ...
                                <?php 
                                    ...
                                    if (strlen($_COOKIE["selected"]) > 0) {
                                        $name = $_COOKIE["selected"];
                                        echo mysqli_fetch_row($conn->query("SELECT highscore FROM " . $name . "_data WHERE username = 'nn'"))[0];
                                    }
                                    }
                                    ?>
                                </p>

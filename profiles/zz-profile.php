<?php
            ...
            $creation = mysqli_fetch_row($conn->query("SELECT * FROM userdata WHERE username = 'zz'"))[3];
                        ...
                        if (isset($user)) {
                            if ($user == $username) {
                                ...
                                if (file_exists("../images/banner/$username-banner.png")) {
                                    echo '<script>document.querySelector(`.banner`).style.backgroundImage = `url(' . '../images/banner/zz-banner.png' . ')`;</script>';
                                }
                    ...
                    <nav>
                        <ul>
                            ...
                            if (file_exists("../images/pfp/$username-pfp.png")) {
                                echo '<script>document.querySelector(`.pfp`).style.backgroundImage = `url(' . '../images/pfp/zz-pfp.png' . ')`;</script>';
                            }
